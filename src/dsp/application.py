...
def exploration_page():
    ...
    chart = (
        alt.layer(consumption_chart, selected_variable_chart)
    ...
    text = heatmap.mark_text(baseline="middle").encode(
        ...
        color=alt.condition(
            "datum.value > 0.5", alt.value("white"), alt.value("black")
        ),
    )
